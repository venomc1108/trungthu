/* =========================================================
   ...
   Yêu cầu xoay ngang trên mobile (overlay)
   ========================================================= */
(function () {
  'use strict';

  /* =======================================================
     1. DỮ LIỆU — 45 NGƯỜI LỚP 10A6
     ======================================================= */
  const PEOPLE = [
    ...
    { name: "Đặng Hà Thủy Tiên",      message: "Chúc Tiên Trung Thu vv, luôn dịu dàng và rạng rỡ💞🥀👀." },
  ...
  function getGridConfig() {
    ...
    // Mobile dọc: 5 cột x 9 hàng (dù có overlay, vẫn render đúng để khi xoay ngang đẹp luôn)
    ...
    // Desktop
    return { cols: 9, rows: 5, areaTop: 28, areaH: 68 };
  }
